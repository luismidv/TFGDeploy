...
const HomePage = () => {
    return (
      <div>
        ...
        <div className = "why-us text-center md:text-left relative md:translate-y-0 translate-y-[1000px] transition-transform duration-300">
        ...
        <section className="why-us why-us text-center md:text-left relative md:translate-y-0 translate-y-[1500px] transition-transform duration-300">
